      ...
      <div className="rounded-2xl bg-gradient-to-r from-violet-500/30 to-blue-500/30 p-px">
        <div className="rounded-2xl bg-white p-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/copilot"
              className="rounded-lg border border-slate-200 px-4 py-2 text-xs font-medium text-slate-500 transition-colors hover:border-slate-300 hover:text-slate-900"
            >
              Ver Mais
            </Link>
          </div>
